...
var KTChartsWidget3M = function () {
    ...
    // Private methods
    var initChart = function(chart) {
        var element = document.getElementById("kt_charts_widget_3M");
        ...
        var options = {
            series: [{
                name: 'Penghasilan',
                data: monthlyExpensesPenghasilan
            }],            
            chart: {
                fontFamily: 'inherit',
                type: 'area',
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTChartsWidget3M;
}

// On document ready
KTUtil.onDOMContentLoaded(function() {
    KTChartsWidget3M.init();
});
